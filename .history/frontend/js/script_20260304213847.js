(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    overlay.style.cssText = 'display:none;position:fixed;top:0;left:0;width:100%;height:100%;background:rgba(0,0,0,0.6);z-index:1500;';
    ...
    function openMenu() {
      ...
      // ✅ Android : bloquer scroll via classe CSS sur html (plus fiable que position:fixed)
    ...
    function closeMenuForNavigation() {
      ...
      overlay.style.display = 'none';
      document.documentElement.classList.remove('menu-open');
      // PAS de restauration scroll — scrollToSection va prendre le relais
    }
    ...
    function scrollToSection(targetId) {
      ...
      // Sur Android avec menu-open, window.pageYOffset peut être 0
      // On utilise _scrollYBeforeMenu si le menu est/était ouvert
      var menuWasOpen = document.documentElement.classList.contains('menu-open');
      var currentScroll = menuWasOpen
        ? _scrollYBeforeMenu
