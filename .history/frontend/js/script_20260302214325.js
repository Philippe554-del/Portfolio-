(function () {
  ...
  // Empêcher le glisser d'images et le clic droit sur les images (indépendant du DOM)
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    // ===== Effet de scroll sur l'en-tête et bouton retour en haut =====
    ...
    // ===== Fonctions utilitaires (sanitize, email, notifications) =====
    ...
    if (voirProjetsBtn) {
      voirProjetsBtn.addEventListener('click', function (e) {
        ...
        if (projetsSection) {
          ...
          window.location.href = '/projets'; // à adapter selon ton site
        }
      });
    }

    // ===== Styles pour les notifications (injectés une seule fois) =====
