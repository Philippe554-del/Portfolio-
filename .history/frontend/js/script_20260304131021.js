(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    // ✅ CORRECTION PRINCIPALE DU SCROLL MOBILE :
    // On utilise addEventListener sur chaque lien du menu DIRECTEMENT,
    // pas via délégation depuis document (qui peut être capturé par d'autres handlers).
    // On mémorise l'ID avant tout, puis on ferme, puis on scrolle après délai.
    function bindMenuLinks() {
      if (!navLinks) return;
      navLinks.querySelectorAll('a[href^="#"]').forEach(function (link) {
        // Supprime les anciens listeners en clonant
        ...
        newLink.addEventListener('click', function (e) {
          ...
          // ✅ Mémorise l'ID AVANT de fermer (car closeMenu modifie le DOM)
          ...
          if (isMenuOpen) {
            ...
            // ET que le navigateur ait relâché overflow:hidden sur body
            setTimeout(function () {
