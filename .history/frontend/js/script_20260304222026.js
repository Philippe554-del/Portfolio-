(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    function closeMenu() {
      ...
      var scrollY = _scrollYBeforeMenu;
      document.body.style.position = '';
      document.body.style.top = '';
      document.body.style.width = '';
      // ✅ Correction Android : utiliser requestAnimationFrame pour éviter les conflits de scroll
    ...
    function scrollToSection(targetId) {
      ...
      if (!target) return;
      // ✅ scrollIntoView est natif, fiable sur tous les Android
      target.scrollIntoView({ behavior: 'smooth', block: 'start' });
    }

    // LIENS DU MENU MOBILE — version simplifiée sans touchend
