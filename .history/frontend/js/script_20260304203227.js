(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    /* ================================================================
       MENU MOBILE — CORRIGÉ ANDROID
    ================================================================ */
    var overlay = document.createElement('div');
    overlay.id = '_nav_overlay';
    overlay.style.cssText = 'display:none;position:fixed;top:0;left:0;width:20%;height:100%;background:rgba(0,0,0,0.01);z-index:1000;cursor:pointer;';
      ...
      navLinks.querySelectorAll('a[href^="#"]').forEach(function (link) {
        ...
        function handleNavLink(e) {
          ...
          if (navLinks.classList.contains('active')) {
            closeMenu();
            setTimeout(function () { scrollToSection(idToScrollTo); }, 50);
          } else {
